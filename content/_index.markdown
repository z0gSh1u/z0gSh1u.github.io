...
- **Main Working Language: TypeScript, Python**
  <br/>
  _I've contributed to [microsoft/TypeScript](https://github.com/microsoft/TypeScript/pull/43654)._
- **Frontend Frameworks/Libraries: React, Vue**
  <br/>
  _I've deployed ASP/PHP webapps (Discuz!, Phpwind, Wordpress and Dvbbs) on virtual hosts in the old day._
- **Server-side and Containerization: Koa (Node.js), Golang, Kubernetes**
  <br/>
  _Participated in the deployment of [Cloud SecretNote](https://studio.secretflow.com/secretnote-case) on Aliyun ACK Serverless during my working at Ant Group._
- **Desktop: Electron**
  <br/>
...
- **Foreign Languages: English CET6 and Japanese N5**
  <br/>_Yep, should improve them both._
- **Learning Now: Rust, and building AI Agents and Apps**
- **Used Several Times: PHP, C++, CUDA**
...
<img src="logo/meituan.png" style="max-width:5%;min-width:32px;float:left;margin-right:24px;" alt="Meituan" draggable="false" />

- 2023.04 - 2023.07: Meituan, Front-End Developer (Vue) (Internship)
  
  > Content Security (Censorship) Platform Development

<img src="logo/first-imaging.png" style="max-width:5%;min-width:32px;float:left;margin-right:24px;" alt="First Imaging" draggable="false" />
...
<img src="logo/tencent.png" style="max-width:5%;min-width:32px;float:left;margin-right:24px;" alt="Tencent" draggable="false" />
...
<img src="logo/rennes1.png" style="max-width:5%;min-width:32px;float:left;margin-right:24px;" alt="Université de Rennes 1" draggable="false" />
...
- [A Hybrid Cone-Beam CT Scatter Correction Method Combining Fast Monte-Carlo Simulation and Deep Neural Network](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=nWCWwY0AAAAJ&citation_for_view=nWCWwY0AAAAJ:IjCSPb-OGe4C) (IEEE Transactions on Instrumentation and Measurement) (Huang W, Xu C, Miao C, **Zhuo X**, Zhong X, Xi Y, Chen Y, Ji X)
